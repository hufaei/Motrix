export default {
  ...
  'download-error-code': '錯誤碼 {{errorCode}}',
  'download-error-unknown-reason': '無法取得具體錯誤原因',
  'download-error-generic-suggestion': '請開啟任務詳情查看原始錯誤，並檢查儲存路徑、磁碟空間和網路後重試。',
  'download-error-original': 'aria2 原始資訊：{{errorMessage}}',
  'download-error-file-exists-reason': '目標位置已有同名檔案，但缺少對應的 .aria2 續傳控制檔；為避免原檔案被清空，下載已取消',
  'download-error-file-exists-suggestion': '請先重新命名或移走衝突檔案，或者改用其他儲存路徑後重新新增任務；確認不需要原檔案時，也可以手動刪除後重試。',
