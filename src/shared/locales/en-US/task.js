export default {
  ...
  'download-error-code': 'Error {{errorCode}}',
  'download-error-unknown-reason': 'No specific error reason was returned',
  'download-error-generic-suggestion': 'Open the task details for the original error, then check the save path, disk space, and network before retrying.',
  'download-error-original': 'aria2 message: {{errorMessage}}',
  'download-error-file-exists-reason': 'A file with the same name already exists without its .aria2 resume control file; the download was canceled to prevent the existing file from being erased',
  'download-error-file-exists-suggestion': 'Rename or move the conflicting file, or choose another save path and add the task again. If the old file is not needed, delete it manually before retrying.',
